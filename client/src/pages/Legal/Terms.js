  ...
  return (
    <div>
      ...
      <div className='legal'>
        ...
        <ol>
          <li><a href="#agreement-to-terms">AGREEMENT TO TERMS</a> </li>
          <li><a href="#intellect">INTELLECTUAL PROPERTY RIGHTS</a></li>
          <li><a href="#user-rep">USER REPRESENTATIONS</a></li>
          <li><a href="#prohibited">PROHIBITED ACTIVITIES</a></li>
          <li><a href="#user-gen">USER GENERATED CONTRIBUTIONS</a></li>
          <li><a href="#contribution">CONTRIBUTION LICENSE</a></li>
          <li><a href="#submission">SUBMISSIONS</a></li>
          <li><a href="#third-party">THIRD-PARTY WEBSITE AND CONTENT</a></li>
          <li><a href="#advertisers">ADVERTISERS</a></li>
          <li><a href="#site-managment">SITE MANAGEMENT</a></li>
          <li><a href="#priv">PRIVACY POLICY</a></li>
          <li><a href="#term-and-termination">TERM AND TERMINATION</a></li>
          <li><a href="#modi">MODIFICATIONS AND INTERRUPTIONS</a></li>
          <li><a href="#governing">GOVERNING LAW</a></li>
          <li><a href="#dispute">DISPUTE RESOLUTION</a></li>
          <li><a href="#corrections">CORRECTIONS</a></li>
          <li><a href="#disclaimer">DISCLAIMER</a></li>
          <li><a href="#limitations-liab">LIMITATIONS OF LIABILITY</a></li>
          <li><a href="#indem">INDEMNIFICATION</a></li>
          <li><a href="#user-data">USER DATA</a></li>
          <li><a href="#elect-comm">ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</a></li>
          <li><a href="#cali-users'">CALIFORNIA USERS AND RESIDENTS</a></li>
          <li><a href="#misce">MISCELLANEOUS</a></li>
          <li><a href="#contact-us">CONTACT US</a></li>
        </ol>
        <div id='agreement-to-terms'>
          <h4>AGREEMENT TO TERMS</h4>
          <p>These Terms of Use constitute a legally binding agreement made between you, whether personally or on behalf of an entity (“you”) and Out of the Box Designs LLC, doing business as Axad Capital ("Axad Capital," “we," “us," or “our”), concerning your access to and use of the https://ratemagician.com website as well as any other media form, media channel, mobile website or mobile application related, linked, or otherwise connected thereto (collectively, the “Site”). We are registered in New York, United States and have our registered office at 246 W 38th St 2nd Street Address: Suite 1401, New York, NY 10018. You agree that by accessing the Site, you have read, understood, and agreed to be bound by all of these Terms of Use. IF YOU DO NOT AGREE WITH ALL OF THESE TERMS OF USE, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SITE AND YOU MUST DISCONTINUE USE IMMEDIATELY.</p>
        ...
        <div id='dispute'>
          ...
          <p>If the Parties are unable to resolve a Dispute through informal negotiations, the Dispute (except those Disputes expressly excluded below) will be finally and exclusively resolved through binding arbitration. YOU UNDERSTAND THAT WITHOUT THIS PROVISION, YOU WOULD HAVE THE RIGHT TO SUE IN COURT AND HAVE A JURY TRIAL. The arbitration shall be commenced and conducted under the Commercial Arbitration Rules of the American Arbitration Association ("AAA") and, where appropriate, the AAA's Supplementary Procedures for Consumer Related Disputes ("AAA Consumer Rules"), both of which are available at the AAA website: www.adr.org. Your arbitration fees and your share of arbitrator compensation shall be governed by the AAA Consumer Rules and, where appropriate, limited by the AAA Consumer Rules. The arbitration may be conducted in person, through the submission of documents, by phone, or online. The arbitrator will make a decision in writing, but need not provide a statement of reasons unless requested by either Party. The arbitrator must follow applicable law, and any award may be challenged if the arbitrator fails to do so. Except where otherwise required by the applicable AAA rules or applicable law, the arbitration will take place in New York, New York. Except as otherwise provided herein, the Parties may litigate in court to compel arbitration, stay proceedings pending arbitration, or to confirm, modify, vacate, or enter judgment on the award entered by the arbitrator.</p>
          <p>If for any reason, a Dispute proceeds in court rather than arbitration, the Dispute shall be commenced or prosecuted in the state and federal courts located in New York, New York, and the Parties hereby consent to, and waive all defenses of lack of personal jurisdiction, and forum non conveniens with respect to venue and jurisdiction in such state and federal courts. Application of the United Nations Convention on Contracts for the International Sale of Goods and the Uniform Computer Information Transaction Act (UCITA) is excluded from these Terms of Use.</p>
        ...
        <div id='limitations-liab'>
          <h4>LIMITATIONS OF LIABILITY</h4>
          <p>IN NO EVENT WILL WE OR OUR DIRECTORS, EMPLOYEES, OR AGENTS BE LIABLE TO YOU OR ANY THIRD PARTY FOR ANY DIRECT, INDIRECT, CONSEQUENTIAL, EXEMPLARY, INCIDENTAL, SPECIAL, OR PUNITIVE DAMAGES, INCLUDING LOST PROFIT, LOST REVENUE, LOSS OF DATA, OR OTHER DAMAGES ARISING FROM YOUR USE OF THE SITE, EVEN IF WE HAVE BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES. NOTWITHSTANDING ANYTHING TO THE CONTRARY CONTAINED HEREIN, OUR LIABILITY TO YOU FOR ANY CAUSE WHATSOEVER AND REGARDLESS OF THE FORM OF THE ACTION, WILL AT ALL TIMES BE LIMITED TO THE LESSER OF THE AMOUNT PAID, IF ANY, BY YOU TO US OR $1.00 USD. CERTAIN US STATE LAWS AND INTERNATIONAL LAWS DO NOT ALLOW LIMITATIONS ON IMPLIED WARRANTIES OR THE EXCLUSION OR LIMITATION OF CERTAIN DAMAGES. IF THESE LAWS APPLY TO YOU, SOME OR ALL OF THE ABOVE DISCLAIMERS OR LIMITATIONS MAY NOT APPLY TO YOU, AND YOU MAY HAVE ADDITIONAL RIGHTS.</p>
        </div>
        <div id='indem'>
        ...
        <div id='contact-us'>
          ...
          <p>United States</p>
          <p>Phone: (+1)6467574752</p>
          <p>ariel@axadcapital.com</p>
        </div>
      </div>
    </div>
  )
